...
namespace Valve.VR.InteractionSystem
{
	...
	public class TeleportPoint : TeleportMarkerBase
	{
		...
		{
            Mesh = GameObject.Find(numberF).GetComponent<MeshRenderer>();
            Mesh.enabled = true;
            return true;
		}
		...
		public override void SetAlpha( float tintAlpha, float alphaPercent )
		{
			...
			markerMesh.material.SetColor( tintColorID, titleVisibleColor);
			switchSceneIcon.material.SetColor( tintColorID, titleVisibleColor);
			moveLocationIcon.material.SetColor( tintColorID, titleVisibleColor);
			lockedIcon.material.SetColor( tintColorID, titleVisibleColor);
